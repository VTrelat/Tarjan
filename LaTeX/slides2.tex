    ...
    \begin{figure}
        ...
        \subfloat{
            \begin{minipage}{0.6\textwidth}
                ...
                Certification du logiciel de pilotage automatique de la ligne 14 de métro à Paris, bientôt la ligne 4
            \end{minipage}
        }
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \onslide<1->{
        \begin{definition}[SCC]
            ...
            $\mathcal{C}$ est une SCC de $\mathcal{G}$ si\footnote{Il suffit de : $\forall x, y \in \mathcal{C}, x \Rightarrow^* y$}:
            \begin{equation*}
