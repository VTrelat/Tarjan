...
\title[Midterm presentation of the research course]{Verification in Isabelle / HOL\\ of an algorithm for computing SCCs}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item A consistent work on the structure of the parallel workers is already is progress
    \end{itemize}
  \end{itemize}
\end{frame}
