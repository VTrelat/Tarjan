    ...
    next
      ...
      next
        ...
        proof (clarify)
          fix u x
          assume asm:"u \<in> vs" "reachable u x"
          have "visited e' = visited e" using e'_def
            by simp
          then show "x \<in> visited e'" sorry
        qed
        ...
        moreover have "\<forall> n \<in> set (stack e'). reachable v n \<longrightarrow> v \<in> \<S> e' n" sorry
